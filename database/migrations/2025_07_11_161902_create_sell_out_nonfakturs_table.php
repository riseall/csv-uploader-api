...
class CreateSellOutNonfaktursTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('selling_out_metd_non_faktur', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('selling_out_metd_non_faktur');
    }
}
